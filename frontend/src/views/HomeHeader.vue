<template>
    <el-header class="navbar">
        <div class="left-navbar">
            ...
            <el-menu :default-active="$route.path ? $route.path : '/tasks'" :router="true" mode="horizontal" :ellipsis="false"
                background-color="#2c3e50" text-color="#0fb2ef" active-text-color="#f59121">
                <el-menu-item index="/tasks" :route="{ name: 'tasks' }">
                    <span slot="title"><b>Timed Task</b></span>
                </el-menu-item>
            </el-menu>
        </div>
...
import logoSrc from '@/assets/ss.gif'


const goToGitHub = () => {
    window.open('https://github.com/SeldomQA/schedule-server', '_blank')
}
